    ...
    roles: [
      {
        ...
        bulletPoints: [
          ...
          "Developed a database migration tool with C# .NET, GitHub Actions CI/CD pipeline and Docker, preventing production failures caused by missing database migrations.",
        ],
        skills: [
          "TypeScript",
          "React",
